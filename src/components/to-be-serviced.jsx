...
import { Wrench, Filter, SortAsc, ArrowLeft } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

// Sample task data for To Be Serviced category
const initialTasks = [
  { 
    id: 1, 
